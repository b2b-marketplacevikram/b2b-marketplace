...
Write-Host "Starting User Service on port $port..." -ForegroundColor Yellow
Write-Host ""

# Navigate to user service directory
Set-Location -Path "c:\b2b_sample\backend\user-service"

Write-Host "📦 Service Details:" -ForegroundColor Cyan
Write-Host "   Name: User Service" -ForegroundColor White
Write-Host "   Port: 8081" -ForegroundColor White
Write-Host "   Functions: Authentication, User Management, JWT" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "User Service has stopped." -ForegroundColor Yellow
