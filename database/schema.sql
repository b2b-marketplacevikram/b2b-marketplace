...
-- ====================================================================
-- This creates a hierarchical structure for product specifications:
-- Classification Classes → Classification Attributes → Product Attribute Values
-- Allows suppliers to enter values for predefined attributes

-- Classification Classes Table (e.g., Memory, Display, Camera, etc.)
...
-- Classification Attributes Table (predefined attributes for each class)
...
-- Product-Classification Mapping (which classes apply to this product)
...
-- Product Attribute Values (supplier enters values here)
