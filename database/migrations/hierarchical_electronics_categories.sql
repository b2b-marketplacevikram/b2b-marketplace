-- Insert hierarchical category structure for Electronics with images
-- First, ensure Electronics exists as a top-level category
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) 
VALUES ('Electronics', 'electronics', 'Electronic products and devices', '💻', 
        'https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=400', NULL, 1, TRUE)
ON DUPLICATE KEY UPDATE 
    image_url = 'https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=400',
    icon = '💻';

-- Get the Electronics category ID (assuming it's 1, or adjust based on your data)
...
-- Level 2 Subcategories under Computers & Laptops
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) VALUES
...
-- Level 2 Subcategories under Mobile Devices
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) VALUES
...
-- Level 2 Subcategories under Audio & Video
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) VALUES
...
-- Level 2 Subcategories under Cameras & Photography
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) VALUES
...
-- Level 2 Subcategories under Home Appliances
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) VALUES
...
-- Level 2 Subcategories under Gaming & Consoles
INSERT INTO categories (name, slug, description, icon, image_url, parent_id, display_order, is_active) VALUES
