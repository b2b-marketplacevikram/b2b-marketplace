...
Write-Host "Starting Payment Service on port $port..." -ForegroundColor Yellow
Write-Host ""

# Navigate to payment service directory
Set-Location -Path "c:\b2b_sample\backend\payment-service"

Write-Host "📦 Service Details:" -ForegroundColor Cyan
Write-Host "   Name: Payment Service" -ForegroundColor White
Write-Host "   Port: 8084" -ForegroundColor White
Write-Host "   Functions: Payment Processing, Transaction Management" -ForegroundColor White
Write-Host ""
...
Write-Host ""
Write-Host "Payment Service has stopped." -ForegroundColor Yellow
